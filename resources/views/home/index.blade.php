...
<head>
    <title>Pusat Pelatihan Kerja Daerah Khusus Kota Jakarta Pusat 2024</title>
    <meta charset="utf-8">
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body justify-content-between">
                    <div class="main-logo">
                        <a href="{{ url('/') }}">
                            <img src="{{ asset('jub/images/jakarta.png') }}" alt="logo" class=""
                                width="180">
                        </a>
                    </div>
                        ...
                        @if (Route::has('login'))
                            @auth
                                ...
                                @if (Auth::user()->usertype == 'admin')
                                    <li class="nav-item">
                                        <a href="{{ url('admin/dashboard') }}" class="nav-link mx-2">
                                            Dashboard
                                        </a>
                                    </li>
                                @endif
                                ...
                                @if (Auth::user()->usertype == 'user')
                                    <li class="nav-item">
                                        <a href="{{ url('user/dashboard') }}" class="nav-link mx-2">
                                            Dashboard
                                        </a>
                                    </li>
                                @endif
                            @else
                                <li class="nav-item">
                                    <a href="{{ route('login') }}" class="nav-link mx-2">
                                        Log in
                                    </a>
                                </li>
                                ...
                                @if (Route::has('register'))
                                    <li class="nav-item">
                                        <a href="{{ route('register') }}" class="nav-link mx-2">
                                            Register
                                        </a>
                                    </li>
                                @endif
    ...
    <section id="hero" style="background-image:url(images/billboard-bg.png); background-repeat: no-repeat; ">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-5 pe-5 mt-5 mt-md-0">
                    <h2 class="display-5 text-uppercase">PPKD Jakarta Pusat 2024</h2>
                    <p class="my-4">Pusat Pelatihan Kerja Daerah (PPKD) Jakarta Pusat merupakan Unit
                        Pelayanan Teknis (UPT) Dinas Tenaga Kerja dan Transmigrasi (Diknakertras) Provinsi DKI Jakarta.
                    </p>
                    <p class="my-4">Berdasarkan SK Gubernur Provinsi DKI Jakarta No. 160 Tahun 2002 tentang
                        Pembentukan Organisasi
                        dan Tata Kerja Unit Pelaksanaan Teknis di lingkungan Disnakertrans Provinsi DKI Jakarta disebut
                        Balai Latihan Kerja Daerah (BLKD) Jakarta Pusat yang tugas utamanya adalah melaksanakan
                        pelatihan di berbagai jurusan.</p>
                    <p class="my-4">Selanjutnya dengan diberlakukannya Peraturan Gubernur Provinsi DKI Jakarta Nomor
                        33 Tahun 2015 Tentang Pembentukan, Organisasi dan Tata Kerja Pusat Pelatihan Kerja Daerah, nama
                        Balai Latihan Kerja Daerah (BLKD) Jakarta Pusat berubah nama menjadi Pusat Pelatihan Kerja
                        Daerah Jakarta Pusat atau yang disingkat dengan PPKD Jakarta Pusat. Kemudian diperbaharui lagi
                        dengan dikeluarkan Peraturan Gubernur Nomor 147 Tahun 2019 Tentang Organisasi Dan Tata Kerja
                        Dinas Tenaga Kerja, Transmigrasi Dan Energi yang berlaku hingga saat ini.</p>
                    <div>
                        {{-- <form id="form" class="d-flex align-items-center position-relative ">
                            <input type="text" name="email" placeholder="what are you trying to learn?"
                                class="form-control bg-white border-5 rounded-4 shadow-none px-4 py-3 w-100">
                            <button
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset('jub/images/ngumpul.jpeg') }}" alt="img" class="img-fluid">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('jub/images/apelpagi.jpeg') }}" alt="img" class="img-fluid">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('jub/images/kegiatan.jpeg') }}" alt="img" class="img-fluid">
                            </div>
                        </div>
    ...
    <section id="category">
        <div class="container ">
            <div class="d-md-flex justify-content-between align-items-center">
                <div>
                    <h2 class="display-6 fw-semibold">Kejuruan & Kompetensi</h2>
                </div>
            </div>
            <div class="row g-md-6 mt-0">
                <div class="col-md-4">
                    <div class="primary rounded-3 p-4 my-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-4">
                                <p class="category-paragraph fw-bold text-uppercase mb-1">Design Grafis</p>
                                <p class="category-paragraph m-0">25 Orang</p>
                            </div>
                        </div>
                    </div>
                    <div class="tertiary rounded-3 p-4 my-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-4">
                                <p class="category-paragraph fw-bold text-uppercase mb-1">Bahasa Inggris</p>
                                <p class="category-paragraph m-0">30 Orang</p>
                            </div>
                        </div>
                    </div>
                    <div class="secondary rounded-3 p-4 my-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-4">
                                <p class="category-paragraph fw-bold text-uppercase mb-1">Content Creator</p>
                                <p class="category-paragraph m-0">20 Orang</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="gray rounded-3 p-4 my-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-4">
                                <p class="category-paragraph fw-bold text-uppercase mb-1">Video Editor</p>
                                <p class="category-paragraph m-0">20 Orang</p>
                            </div>
                        </div>
                    </div>
                    <div class="secondary rounded-3 p-4 my-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-4">
                                <p class="category-paragraph fw-bold text-uppercase mb-1">Web Programming</p>
                                <p class="category-paragraph m-0">20 Orang</p>
                            </div>
                        </div>
                    </div>
                    <div class="tertiary rounded-3 p-4 my-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-4">
                                <p class="category-paragraph fw-bold text-uppercase mb-1">Jaringan Komputer</p>
                                <p class="category-paragraph m-0">20 Orang</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="tertiary rounded-3 p-4 my-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-4">
                                <p class="category-paragraph fw-bold text-uppercase mb-1">Otomotif</p>
                                <p class="category-paragraph m-0">20 Orang</p>
                            </div>
                        </div>
                    </div>
                    <div class="primary rounded-3 p-4 my-3">
                        <div class="d-flex align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="60px" height="60px">
                                <use href="#handshake" class="svg-primary" />
                            </svg>
                            <div class="ps-4">
                                <p class="category-paragraph fw-bold text-uppercase mb-1">Tata Graha</p>
                                <p class="category-paragraph m-0">40 Orang</p>
                            </div>
                        </div>
                    </div>
                    <div class="gray rounded-3 p-4 my-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-4">
                                <p class="category-paragraph fw-bold text-uppercase mb-1">Tata Busana</p>
                                <p class="category-paragraph m-0">20 Orang</p>
                            </div>
                        </div>
                    </div>
    ...
    <section id="points" class="padding-medium pt-0">
        <div class="container">
            <div class="text">
                <h2 class="display-6 fw-semibold">Fasilitas</h2>
            </div>
            <div class="row align-items-center mt-5">
                <div class="col-md-4 pe-md-5">
                    ...
                    <div class="d-flex">
                        ...
                        <p class="ps-4">Peralatan Pelatihan.
                        </p>
                    </div>
                    <div class="d-flex">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px">
                    ...
                    <div class="d-flex">
                        ...
                        <p class="ps-4">Modul & Materi Pelatihan.</p>
                    </div>
                    <div class="d-flex">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px">
                            <use href="#tick-circle" class="text-secondary" />
                        </svg>
                        <p class="ps-4">Dipromosikan Ke Berbagai Perusahaan.</p>
                    </div>
                ...
                <div class="col-md-6 pe-md-5">
                    ...
                    <div class="d-flex">
                        ...
                        <p class="ps-4">Makan Siang.</p>
                    </div>
                    <div class="d-flex">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px">
                            <use href="#tick-circle" class="text-secondary" />
                        </svg>
                        <p class="ps-4">Baju Kerja.</p>
                    </div>
                    <div class="d-flex">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px">
                            <use href="#tick-circle" class="text-secondary" />
                        </svg>
                        <p class="ps-4">Sertifikat Pelatihan.</p>
                    </div>
                    <div class="d-flex">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px">
                            <use href="#tick-circle" class="text-secondary" />
                        </svg>
                        <p class="ps-4">Sertifikat Kompetensi.</p>
                    </div>
        ...
        <div class="container padding-medium">
            <div class="row align-items-center">
                <div class="offset-md-1 col-md-5 ">
                    <div>
                        <h2 class="display-6 fw-semibold">Daftar Sekarang Juga!</h2>
                        <p class="text-secondary ">Banyak Keuntungan Yang Bisa Kamu Dapatkan</p>
                    </div>
                </div>
                <div class="col-md-5">
                    <form id="form">
                        <input type="email" name="email" placeholder="Daftar Disini*"
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-4 my-3">
                    <div class="footer-menu">
                        <a href="{{ url('/') }}">
                            <img src="{{ asset('jub/images/contactusss.png') }}" alt="logo" class="#"
                                width="200">
                        </a>
                        <div class="social-links mt-4">
                            <ul class="d-flex list-unstyled ">
                                <li class="me-4">
                                    <a href="https://www.facebook.com/p/PPKD-Jakarta-Pusat-100069339140938/?_rdr">
                                ...
                                <li class="me-4">
                                    <a href="https://www.instagram.com/ppkdjp/?hl=id">
                                        <svg class="social-icon" width="30" height="30" aria-hidden="true">
                                ...
                                <li class="me-4">
                                    <a href="https://www.youtube.com/@ppkdjp">
                                        <svg class="social-icon" width="30" height="30" aria-hidden="true">
                ...
                <div class="col-sm-6 col-lg-2 my-3">
                    <div class="footer-menu">
                        <h5 class=" fw-bold mb-4">Interactive Maps</h5>
                        <iframe
                            src="https://www.google.com/maps/embed/v1/place?q=ppkd+jakarta+pusat&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
                            frameborder="50" style="border:50px; width: 200%; height: 290px;"
                        ...
                        <div class="footer-menu">
                            ...
                            <ul class="menu-list list-unstyled">
                                <li class="menu-item mb-2">
                                    <a href="#" class="footer-link">ppkdjakpus@gmail.com</a>
                                </li>
                                <li class="menu-item mb-2">
                                    <a href="#" class="footer-link">+021 554433 2211</a>
                                </li>
                                <li class="menu-item mb-2">
                                    <a href="#" class="footer-link">Jakarta, Indonesia</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-4 my-3">
                        <div class="footer-menu">
                            ...
                            <ul class="menu-list list-unstyled">
                                ...
                                <li class="menu-item mb-2">
                                    <a href="{{ url('/') }}" class="footer-link">About us</a>
                                </li>
                                <li class="menu-item mb-2">
                                    <a href="{{ url('/') }}" class="footer-link">Courses</a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row py-3">
                <div class="col-md-6 copyright">
                    <p>© 2024 Pusat Pelatihan Kerja Daerah Khusus Jakarta. All rights reserved.</p>
                </div>
